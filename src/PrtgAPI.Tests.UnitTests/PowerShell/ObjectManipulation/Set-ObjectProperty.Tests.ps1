    ...
    Context "Default" {
        ...
        It "specifies a PrimaryChannel with a Channel value" {
            ...
            SetAddressValidatorResponse @(
                ...
                [Request]::EditSettings("id=4000&primarychannel_=1%7CPercent+Available+Memory+(%25)%7C&nosession=1")
            )
        ...
        It "specifies a PrimaryChannel with a string value" {
            ...
            $response = SetAddressValidatorResponse @(
                ...
                [Request]::ChannelProperties(4000, 1)
                [Request]::EditSettings("id=4000&primarychannel_=0%7CPercent+Available+Memory0+(%25)%7C&nosession=1")
            )
        ...
        It "specifies a PrimaryChannel that has different channel IDs on different sensors" {
            ...
            $response = SetAddressValidatorResponse @(
                ...
                [Request]::EditSettings("id=4000,4002&primarychannel_=0%7CPercent+Available+Memory+(%25)%7C&nosession=1")
                [Request]::EditSettings("id=4001,4003&primarychannel_=1%7CPercent+Available+Memory+(%25)%7C&nosession=1")
    ...
    Context "Dynamic" {
        ...
        It "specifies a -PrimaryChannel and another property" {
            ...
            $response = SetAddressValidatorResponse @(
                ...
                [Request]::ChannelProperties(4000, 0)
                [Request]::ChannelProperties(4000, 1)
                [Request]::EditSettings("id=4000&primarychannel_=0%7CPercent+Available+Memory0+(%25)%7C&interval_=600%7C10+minutes&intervalgroup=0&nosession=1")
            )
        ...
        It "specifies a -PrimaryChannel that has different channel IDs on different sensors and another property" {
            ...
            $response = SetAddressValidatorResponse @(
                ...
                [Request]::Channels(4003)
                [Request]::ChannelProperties(4003, 1)
                [Request]::EditSettings("id=4000,4002&primarychannel_=0%7CPercent+Available+Memory+(%25)%7C&interval_=600%7C10+minutes&intervalgroup=0&nosession=1")
                [Request]::EditSettings("id=4001,4003&primarychannel_=1%7CPercent+Available+Memory+(%25)%7C&interval_=600%7C10+minutes&intervalgroup=0&nosession=1")
