...
namespace PrtgAPI.NotificationActions
{
    ...
    /// </summary>
    [XmlRoot(NotificationAction.CategoryPush)]
    public class NotificationActionPushSettings : BaseNotificationActionSettings
    {
        ...
        /// <summary>
        /// PRTG user to send notification to. Can be used in conjunction with <see cref="UserGroup"/>.
        /// </summary>
        ...
        /// <summary>
        /// PRTG group to send notification to. Can be used in conjunction with <see cref="UserAccount"/>.
        /// </summary>
