...
namespace PrtgAPI.Request
{
    ...
    public class PrtgTargetHelper
    {
        ...
        public List<ExeFileTarget> GetExeXmlFiles(Either<Device, int> deviceOrId, Func<int, bool> progressCallback = null, int timeout = 60, CancellationToken token = default(CancellationToken)) =>
            client.ResolveSensorTargets(deviceOrId, SensorType.ExeXml, progressCallback, timeout, token, ExeFileTarget.GetFiles);
        ...
        public async Task<List<ExeFileTarget>> GetExeXmlFilesAsync(Either<Device, int> deviceOrId, Func<int, bool> progressCallback = null, int timeout = 60, CancellationToken token = default(CancellationToken)) =>
            await client.ResolveSensorTargetsAsync(deviceOrId, SensorType.ExeXml, progressCallback, timeout, token, ExeFileTarget.GetFiles).ConfigureAwait(false);
        ...
        public List<WmiServiceTarget> GetWmiServices(Either<Device, int> deviceOrId, Func<int, bool> progressCallback = null, int timeout = 60, CancellationToken token = default(CancellationToken)) =>
            client.ResolveSensorTargets(deviceOrId, SensorType.WmiService, progressCallback, timeout, token, WmiServiceTarget.GetServices);
        ...
        public async Task<List<WmiServiceTarget>> GetWmiServicesAsync(Either<Device, int> deviceOrId, Func<int, bool> progressCallback = null, int timeout = 60, CancellationToken token = default(CancellationToken)) =>
            await client.ResolveSensorTargetsAsync(deviceOrId, SensorType.WmiService, progressCallback, timeout, token, WmiServiceTarget.GetServices).ConfigureAwait(false);
        ...
        public List<SqlServerQueryTarget> GetSqlServerQueries(Either<Device, int> deviceOrId, Func<int, bool> progressCallback = null, int timeout = 60, CancellationToken token = default(CancellationToken)) =>
            client.ResolveSensorTargets(deviceOrId, SensorType.SqlServerDB, progressCallback, timeout, token, SqlServerQueryTarget.GetQueries);
        ...
        public async Task<List<SqlServerQueryTarget>> GetSqlServerQueriesAsync(Either<Device, int> deviceOrId, Func<int, bool> progressCallback = null, int timeout = 60, CancellationToken token = default(CancellationToken)) =>
            await client.ResolveSensorTargetsAsync(deviceOrId, SensorType.SqlServerDB, progressCallback, timeout, token, SqlServerQueryTarget.GetQueries).ConfigureAwait(false);
        ...
        public List<GenericSensorTarget> GetSensorTargets(Either<Device, int> deviceOrId, string sensorType, string tableName = null, Func<int, bool> progressCallback = null, int timeout = 60, CancellationToken token = default(CancellationToken)) =>
            client.ResolveSensorTargets(deviceOrId, sensorType, progressCallback, timeout, token, r => GenericSensorTarget.GetTargets(r, tableName));
        ...
        /// <exception cref="TimeoutException">Sensor targets failed to resolve within the specified timespan.</exception>
        /// <returns>If the request is allowed to run to completion, a generic list of sensor targets. If the request is aborted from the progress callback, this method returns null.</returns>
        public async Task<List<GenericSensorTarget>> GetSensorTargetsAsync(Either<Device, int> deviceOrId, string sensorType, string tableName = null, Func<int, bool> progressCallback = null, int timeout = 60, CancellationToken token = default(CancellationToken)) =>
            await client.ResolveSensorTargetsAsync(deviceOrId, sensorType, progressCallback, timeout, token, r => GenericSensorTarget.GetTargets(r, tableName)).ConfigureAwait(false);
    }
}
