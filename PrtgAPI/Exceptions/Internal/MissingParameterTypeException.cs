...
namespace PrtgAPI.Exceptions.Internal
{
    ...
    public class MissingParameterTypeException : Exception
    {
        ...
        /// </summary>
        /// <param name="parameter">The parameter missing a <see cref="Attributes.ParameterType"/> property that caused this exception.</param>
        ...
        {
            return $"Parameter '{parameter.ToString()}' is missing a '{nameof(Attributes.ParameterType)}' attribute. This error message indicates an internal bug that must be corrected.";
        }
    }
}
