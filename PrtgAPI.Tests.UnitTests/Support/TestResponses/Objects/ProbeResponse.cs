...
{
    public class ProbeResponse : BaseResponse<ProbeItem>
    {
        internal ProbeResponse(params ProbeItem[] probes) : base("probenode", probes)
        {
        }

        public override XElement GetItem(ProbeItem item)
        {
            var xml = new XElement("item",
                ...
                new XElement("condition_raw", item.ConditionRaw),
